...
const Skills = () => (
    <section className="skills" id="skills">
        <div className="container">
            <h2 className="title" style={{ color: '#102C57', fontWeight: 800 }} data-aos="zoom-in">My Skills</h2>
            <div className="skills-content df">
                <div className="column left">
                    <div className="text" style={{ color: '#102C57', fontWeight: 700 }} data-aos="zoom-in">My Creative Skills & Experiences.</div>
                    ...
                    <a href="#" data-aos="flip-up">Read more</a>
                </div>
                <div class="column right">
                    <div class="bars" data-aos="fade-left">
